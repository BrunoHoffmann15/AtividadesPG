...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercício 3 -- Bruno da Siqueira Hoffmann", nullptr, nullptr);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
			400.0, 10.0, 0.0, // vertice 1
			100.0, 10.0, 0.0, // vertice 2
			250.0, 400.0, 0.0, // vertice 3
	};
